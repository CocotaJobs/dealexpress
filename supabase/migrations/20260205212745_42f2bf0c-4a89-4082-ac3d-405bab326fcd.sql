...
-- Update handle_new_user trigger to add email-based fallback for invitation matching
-- and duplicate profile prevention
...
BEGIN
  ...
  ELSE
    ...
    LIMIT 1;
    -- If no invitation found by email, invitation_record remains NULL
    -- and a new organization will be created (existing behavior)
  END IF;
